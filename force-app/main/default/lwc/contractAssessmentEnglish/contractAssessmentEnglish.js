...
import { OMNIDEF } from './contractAssessmentEnglish_def.js';
import tmpl from './contractAssessmentEnglish.html';
import tmpl_nds from './contractAssessmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class contractAssessmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
