...
import { OMNIDEF } from './pOCTestEnglish_def.js';
import tmpl from './pOCTestEnglish.html';
import tmpl_nds from './pOCTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pOCTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
